...
public class ListboxBean {
	...
	public static Map<String, Object> getYear2Value() {
		return year2Value;
	}

	public static void setYear2Value(Map<String, Object> year2Value) {
		ListboxBean.year2Value = year2Value;
	}
	...
	public String getView() {
		return "/ui-controls/listboxControlView";
	}
}
