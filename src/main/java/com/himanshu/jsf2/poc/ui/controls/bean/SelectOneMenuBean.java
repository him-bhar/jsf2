...
public class SelectOneMenuBean {
	...
	static {
		...
		coffee2Value.put("Coffee2 - Cream Latte", "Cream Latte"); // label,
																	// value
	...
	public String getView() {
		return "/ui-controls/selectOneMenuControlView";
	}

	public static Map<String, Object> getCoffee2Value() {
		return coffee2Value;
	}

	public static void setCoffee2Value(Map<String, Object> coffee2Value) {
		SelectOneMenuBean.coffee2Value = coffee2Value;
	}

	public Coffee[] getCoffee3List() {
		return coffee3List;
	}

	public void setCoffee3List(Coffee[] coffee3List) {
		this.coffee3List = coffee3List;
	}
}
